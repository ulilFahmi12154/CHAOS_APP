...
class _NutrientRecommendationScreenState
  ...
  String _normalizeToKey(String s) {
    return s.toLowerCase().replaceAll(RegExp(r'[^a-z0-9]+'), '_').replaceAll(RegExp(r'^_+|_+\$'), '');
  }
  ...
  Map<String, dynamic> _getRecommendationDetail(
    ...
    if (value < min) {
      ...
      description = 'Tanaman kekurangan unsur $nutrient. Segera lakukan tindakan pemupukan untuk mengembalikan kesehatan tanaman.';
      color = Colors.red;
      icon = Icons.error;
      checkTime = '2-3 hari';
      ...
      if (nutrient == 'Nitrogen') {
        ...
        fertilizers = ['TSP/SP-36 (36% P₂O₅)', 'DAP (46% P₂O₅)', 'NPK 15-15-15'];
      ...
      description = 'Kadar $nutrient terlalu tinggi. Dapat menyebabkan gangguan penyerapan unsur lain dan kerusakan akar.';
      ...
      description = 'Kadar $nutrient sudah optimal. Pertahankan kondisi ini dengan pemupukan rutin sesuai jadwal.';
      color = Colors.green;
          ...
          children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: ecConditionColor.withOpacity(0.4), width: 2),
                      ),
                      child: Column(
                        children: [
                          Row(
            ...
            StreamBuilder<DatabaseEvent>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData && snapshot.data!.snapshot.value != null) {
                  final data = snapshot.data!.snapshot.value as Map<dynamic, dynamic>;
                  nitrogen = (data['nitrogen'] is num) ? (data['nitrogen'] as num).toDouble() : 0.0;
                  phosphorus = (data['phosphorus'] is num) ? (data['phosphorus'] as num).toDouble() : 0.0;
                  potassium = (data['potassium'] is num) ? (data['potassium'] as num).toDouble() : 0.0;
                }

                // Calculate status for each nutrient
                final nStatus = _getNutrientStatus(nitrogen, nitrogenMin, nitrogenMax);
                final pStatus = _getNutrientStatus(phosphorus, phosphorusMin, phosphorusMax);
                final kStatus = _getNutrientStatus(potassium, potassiumMin, potassiumMax);
                ...
                final normalCount = [nStatus, pStatus, kStatus].where((s) => s == 'Normal').length;
                final kekuranganCount = [nStatus, pStatus, kStatus].where((s) => s == 'Kekurangan').length;
                final berlebihCount = [nStatus, pStatus, kStatus].where((s) => s == 'Berlebih').length;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: conditionColor.withOpacity(0.5), width: 2.5),
                        boxShadow: [
                          BoxShadow(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Icon(conditionIcon, color: conditionTextColor, size: 32),
                              const SizedBox(width: 12),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: detail['color'].withOpacity(0.3)),
                        ),
                        child: Column(
                          children: [
                            Row(
                            ...
                            ClipRRect(
                              borderRadius: BorderRadius.circular(4),
                              child: LinearProgressIndicator(
                                value: ((currentValue - minValue) / (maxValue - minValue)).clamp(0.0, 1.0),
                                minHeight: 8,
                                backgroundColor: Colors.grey.shade300,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(Icons.spa, color: Colors.green.shade700, size: 20),
                                const SizedBox(width: 8),
                                Text(
                            ...
                            const SizedBox(height: 8),
                            ...detail['fertilizers'].map<Widget>((fertilizer) => Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.water_drop, color: Colors.blue.shade700, size: 16),
